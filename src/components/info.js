...
const updates = [
    {date: "19 October 2020 ", content: "Update: Added New Blog Post. Corrected spelling. :P"},
    {date: "1 October 2020 ", content: "Update: Added ReactFullStackSkeleton Project, updated Blog, and changed the updates tab."},
